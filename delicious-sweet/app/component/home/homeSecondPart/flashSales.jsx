        ...
        >
          {relatedProducts.map((product, index) => (
            <SwiperSlide key={product.id || index}>
              <div className={`${styles.productCard} position-relative mb-3`}>
                <img
                ...
                <div className={`${styles.cardTitle} position-relative z-3`}>
                  {product.name}
                </div>
                  ...
                  >
                    {product.discount > 0 ? (
                      <>
                        ...
                        <div className="ms-2 text-decoration-line-through ">
                          $
                          {product.discount_type === "percent"
                            ? (
                                product.unit_price -
